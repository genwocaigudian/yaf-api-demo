...
$pushLibPath = dirname(__DIR__) . '/library/ThirdParty/Getui/';
...
define('APPKEY','CQOhtqVv04AMurnFYS8heA');
define('APPID','iCa1NbnBEn8HZjUNuYwuk7');
define('MASTERSECRET','yVcqbFpNFS7dINqUTxlxB9');
...
class PushModel {
    ...
    private function _IGtTransmissionTemplateDemo($msg = '测试离线ddd'){
